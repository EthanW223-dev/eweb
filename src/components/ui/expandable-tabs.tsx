...
interface ExpandableTabsProps {
  ...
  /** Controlled selected index. When provided, the active tab follows this value. */
...
export function ExpandableTabs({
  ...
  useOnClickOutside(outsideClickRef as React.RefObject<HTMLElement>, () => {
    // In controlled (route-driven) mode the active tab follows the URL, so
    // don't clear it on outside clicks.
    if (!isControlled) {
